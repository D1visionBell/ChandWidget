...
public class PriceWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context ctx, AppWidgetManager mgr, int appWidgetId) {
        ...
        // Click → open Config Activity (FIX: use getActivity not getBroadcast)
        ...
        cfgIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        for (int slot = 0; slot < 3; slot++) {
            ...
            // Red = up (Iranian convention), Green = down
    ...
    private static void triggerFetch(Context ctx) {
        ...
        // FIX: Android 12+ requires ForegroundService for background starts
